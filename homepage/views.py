...
from .models import friends_db, icecream_db
from .services import what_weather, what_temperature, what_conclusion
...
def index(request):
    ...
    if request.method == 'POST':
        selected_friend = request.POST.get('friend', False)
        selected_icecream = request.POST.get('icecream', False)
